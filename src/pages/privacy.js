    ...
    <section className="terms-section">
      <div className="container">
        <div className="content">
          ...
          <p className="last-update">Last Updated Date: 26 October 2023</p>
          <div className="data">
            ...
            <div>
              ...
              <ul className={"list-disc pl-5"}>
                <li className={"context-text"}>you have given us consent;</li>
                <li className={"context-text"}>
            ...
            <div>
              ...
              <p className={"context-text"}>
                ...
                through mobile devices, you can enable a "do not track" feature
                so as to control interest-based advertising on an iOS or Android
