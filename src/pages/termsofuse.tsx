          ...
          <Box className="content">
            ...
            <Box className="data">
              <Text className={"contentClass"} mb={4}>
                ...
                <b>Terms</b>”) carefully, as they set forth legally binding
                terms and conditions between you and the Company (as defined
                below) that govern your access and/or use of: (a) the website
                located at https://persistence.one/ and its associated domains
                (collectively, the “<b>Website</b>”); (b) the Persistence
                Supported Products (as defined below); and (c) the Persistence
                Chain (as defined below), including related trademarks, and
                other intellectual property (all the products collectively
                described in the foregoing of this Paragraph, including the
                Website and Supported Wallet (as defined herein), the “
                <b>Persistence Products</b>”), whether such access and/or use is
                via (i) the Website (“<b>Website Access</b>”) or (ii) command
                line, locally installed programs, Software Development Kits
                (“SDK”), software code and blockchain and smart contract
                explorers (collectively “<b>Direct Access</b>”). These Terms are
                to be read together with the provisions set forth in our privacy
                policy found at{" "}
                <a
              ...
              <Text className={"contentClass"} mb={4}>
                By accessing and/or using any Persistence Product or by
                receiving any Communication (as defined herein) related to any
                Persistence Product, you (“<b>you</b>” or the “<b>User</b>”)
                agree to these Terms on behalf of yourself and any entity you
                represent, and you represent and warrant that you have the right
                and authority to do so.
              </Text>
              <Text className={"contentClass"} mb={4}>
                <b>
                  The Persistence Products are not intended for (a) access
                  and/or use by Excluded Persons (as defined below); or (b)
                  access and/or use by any person or entity in, or accessing or
                  using the Persistence Products from, an Excluded Jurisdiction.
              ...
              <Text className={"contentClass"} mb={4}>
                ...
                (“Company”), an entity formed under the laws of the British
                Virgin Islands and the Persistence Products are copyrighted
                works belonging to the Company and/or its Affiliate(s) (each of
                User and Company, a “<b>Party</b>”, and collectively, the “
                <b>Parties</b>
                ”).
              </Text>
              <Text className={"contentClass"} mb={4}>
              ...
              <Text className={"contentClass"} mb={4}>
                ...
                discretion from time to time. The “Date Last Revised” specified
                on these Terms indicates the date on which the Terms were last
                ...
                access and/or use Persistence Products. Your acceptance of,
                and/or your continued access and/or use of Persistence Products
                following notice of, the updated Terms shall indicate your
                acknowledgement of, and agreement to be bound by, such updated
                Terms.
              </Text>
              <Text className={"contentClass"} mb={4}>
                By using Persistence Products (which for the purposes hereof
                includes but is not limited to accessing the Website), you
                acknowledge and agree that you are dealing solely with the
                Company as counterparty in respect of your use of Persistence
                Products, which shall supersede and replace all prior agreements
                and counterparty relationships entered into with any of the
                Company’s Affiliates in respect of such use.
              </Text>
              ...
              <Box>
                ...
                <Text className={"contentClass"} mb={4}>
                  1.2 For purposes hereof, any software, application,
                  integration, token (including but not limited to Supported
                  Wallet, the Token(s)) or infrastructure which allows for
                  interaction with the Persistence Chain that is supported by
                  the Company shall for the purposes hereof be referred to as a
                  “Persistence Supported Product” and “Persistence Supported
                ...
                <UnorderedList className={"list-disc pl-5"}>
                  <ListItem className={"contentClass"} mb={4}>
                    ...
                    such person, including without limitation any general
                    partner, managing member, officer, director or trustee of
                    such person, or any venture capital fund or investment
                    company now or hereafter existing that is controlled by one
                    or more general partners, managing members or investment
                    adviser of, or shares the same management company or
                    investment adviser with, such person.of an entity means the
                    owners, directors, officers, employees, advisors, and agents
                    of such entity and companies in which such entity has an
                    interest;
                  </ListItem>
                  <ListItem className={"contentClass"} mb={4}>
                    ...
                    the shares of the controlled corporation and, with respect
                    to any person other than a corporation, the possession,
                  ...
                  <ListItem className={"contentClass"} mb={4}>
                    “<b>Persistence Associated Entities</b>” refers to the
                    Company and its Affiliates and its respective Affiliates;
                  </ListItem>
                  <ListItem className={"contentClass"} mb={4}>
                    “<b>Token</b>” refers to the proof-of-stake utility and
                    governance token of Persistence Chain called Persistence
                    token or XPRT, which purpose and function is to secure the
                ...
                <UnorderedList className={"list-disc pl-5"}>
                  ...
                  <ListItem className={"contentClass"} mb={4}>
                    any law or regulation is a reference to that law or
                    regulation as amended from time to time and, where the same
                    has been repealed, to any re-enactment or replacement of the
                    same.
                  </ListItem>
                </UnorderedList>
                <Text className={"contentClass"} mb={4}>
                ...
                <UnorderedList className={"list-disc pl-5"}>
                  <ListItem className={"contentClass"} mb={4}>
                    ...
                    interface to access, use and/or interact with the
                    Persistence Chain, although the Persistence Chain is also
                    accessible / can be used via Direct Access. Company may
                    modify or discontinue support for the Website at any time,
                    in its sole discretion.
                  </ListItem>
                  <ListItem className={"contentClass"} mb={4}>
                    You are hereby granted a non-exclusive, non-transferable,
                    revocable, limited licence to electronically access and use
                    the Website in the manner described in these Terms. You do
                    not have the right, and nothing in these Terms shall be
                    construed as granting you the right, to sub-license any
                    rights in connection with the access and/or use of the
                    Website. Company may revoke or terminate this licence at any
                    time if you use, or attempt to use, the Website in a manner
                    prohibited by these Terms, or if your rights under these
                    Terms are terminated pursuant to Section 7.
                  </ListItem>
                </UnorderedList>
                <Text className={"contentClass"} mb={4}>
                  ...
                  that Company and its Affiliates shall have no responsibility
                  for any loss occasioned to a User by or attributable to Direct
                  Access.
                </Text>
                <Text className={"contentClass"} mb={4}>
                ...
                <UnorderedList className={"list-disc pl-5"}>
                  ...
                  <ListItem className={"contentClass"} mb={4}>
                    Persistence Chain is an open-source software accessible at
                    the Github Page, and is maintained and modifiable by the
                    Company (and/or its Affiliates) subject to Token governance
                    processes from time to time. You agree that save for the
                    right to access and/or use the Persistence Products on the
                    terms expressly provided herein, you shall not acquire
                    and/or own any legal right, title and/or interest in the
                    Persistence Products or any intellectual property rights
                    associated thereto, which shall be wholly owned by the
                ...
                <UnorderedList className={"list-disc pl-5"}>
                  <ListItem className={"contentClass"} mb={4}>
                    ...
                    Fees”) in the form of “gas fees” (generally denominated in
                    the Token) are applicable when certain on-chain transactions
                    are execution (including but not limited to making Token
                    transfers, staking Tokens etc.) (each, a “Persistence
                    On-Chain Transaction”). Please refer to the Website or the
                  ...
                  <ListItem className={"contentClass"} mb={4}>
                    ...
                    that such User connects to the Persistence Chain for
                    purposes of effecting a Persistence On-Chain Transaction, at
                    the time such Persistence On-Chain Transaction is processed.
                    Similar transaction fees may also be levied on Users
                    accessing and using the Persistence Chain via Direct Access.
                  </ListItem>
                </UnorderedList>
                <Text className={"contentClass"} mb={4}>
                  1.8 Non-circumvention. You agree not to do anything, including
                  the use of any technology such as virtual private networks
                  (VPN) for the purposes of circumventing these Terms.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  ...
                  Persistence Products. You hereby declare and represent that
                  the IP address associated with your use of Persistence
                  Products is unique and exclusive to you and shall remain as
                  such.
                </Text>
              </Box>
              <Text className={"subHeading"}>
              ...
              <Box>
                ...
                <UnorderedList className={"list-disc pl-5"}>
                  <ListItem className={"contentClass"} mb={4}>
                    ...
                    Chain; (iv) claiming staking rewards; (v) voting on
                    governance proposals pertaining to Persistence Chain; (vii)
                    accessing the Persistence Chain using a wallet application
                    (including
                    <a
                  ...
                  <ListItem className={"contentClass"} mb={4}>
                    A User accessing and/or using Persistence Products for any
                    of the Activities or for any other purpose is deemed to have
                    read and understood the Persistence Documentation, and
                    acknowledges and accepts all risks and fees relating to the
                    ...
                    with third-party integrations available for use in
                    association with Persistence Chain e.g. Keplr, etc.).
                  </ListItem>
                </UnorderedList>
                <Text className={"contentClass"} mb={4}>
                  <b>
              ...
              <Box>
                <Text className={"contentClass"} mb={4}>
                  3.1 In accessing and/or using any Persistence Product
                  (including interacting with the Persistence Chain using
                  Supported Wallet), User makes the following representations
                  and warranties:
                </Text>
                <UnorderedList className={"list-disc pl-5"}>
                  <ListItem className={"contentClass"} mb={4}>
                    User is at least eighteen (18) years of age, and has the
                    full right, power and authority to access and/or use
                    Persistence Products (including the tools made available in
                    respect thereof), and to enter into and comply with these
                    Terms;
                  </ListItem>
                  <ListItem className={"contentClass"} mb={4}>
                    User is not prohibited and/or restricted under the laws of
                    any jurisdiction applicable to User from accessing and/or
                    using Persistence Products, and/or from using the Supported
                    Wallet in connection with User’s use of Persistence
                    Products;
                  </ListItem>
                  <ListItem className={"contentClass"} mb={4}>
                    User is compliant with all laws of any jurisdiction
                    applicable to User in relation to User’s access and/or use
                    of Persistence Products and acknowledges and agrees that the
                    Persistence Associated Entities are not liable for User’s
                    compliance or non-compliance with any such laws;
                  </ListItem>
                  <ListItem className={"contentClass"} mb={4}>
                  ...
                  <ListItem className={"contentClass"} mb={4}>
                    User is not an Excluded Person (as defined below), and User
                    is not accessing and/or using Persistence Products from an
                    Excluded Jurisdiction (as defined below);
                  </ListItem>
                  <ListItem className={"contentClass"} mb={4}>
                    User has not had User’s access or use of Persistence
                    Products previously terminated or revoked for any reason
                    whatsoever;
                  </ListItem>
                  <ListItem className={"contentClass"} mb={4}>
                    User will not, and will not attempt to, authorize anyone
                    other than User to access and/or use Persistence Products
                    using a Supported Wallet or Persistence Chain-compatible
                    blockchain address owned by User, or otherwise engage in
                    Prohibited Use (as defined below) of such Supported Wallet
                    Persistence Chain-compatible blockchain address;
                  </ListItem>
                  <ListItem className={"contentClass"} mb={4}>
                    ...
                    Supported Wallet or Token (as the case may be) and/or to
                    hold and/or deploy, the Token; and
                  </ListItem>
                  <ListItem className={"contentClass"} mb={4}>
                    ...
                    and User has evaluated and understands the use of
                    Persistence Products and has not relied on any information,
                    statement, representation, or warranty, express or implied,
                    made by or on behalf of Persistence Associated Entities with
                    respect to Persistence Products whether as regards the
                    suitability, reliability, security or otherwise of
                    Persistence Products and/or Persistence Chain.
                  </ListItem>
                </UnorderedList>
                <Text className={"contentClass"} mb={4}>
                  {" "}
                  Each and all of User’s above representations and warranties
                  are true, complete, accurate and not misleading from the time
                  of User’s acceptance of these Terms and are deemed repeated
                  each time User uses Persistence Products.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  3.2{" "}
                  <b>
                ...
                <Text className={"contentClass"} mb={4}>
                  ...
                  support (to the extent it is able to or practically able to)
                  for Persistence Products at any time.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  3.4 User shall be responsible for obtaining the data network
                  access necessary to use and/or access Persistence Products,
                  and for acquiring compatible hardware or device necessary to
                  access and use Persistence Products and any updates thereto.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  3.5 Use of Persistence Products may be disrupted as a result
                  of malfunction and/or delays which are inherent to the use of
                  the internet and electronic communications, and User agrees
                  that the Persistence Associated Entities shall not be
                  responsible for any such disruption, malfunction and/or delay,
                  and any loss which may arise therefrom.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  ...
                  User’s own personal use to the extent required to access and
                  use the tools and information made available via the Website.
                  Unless with our prior written consent, the Website and its
                  contents must not be reproduced, modified, redistributed or
                  otherwise used for any other reason.{" "}
                </Text>
                <Text className={"contentClass"} mb={4}>
                  ...
                  content from the Website via automated means, and User shall
                  not use automated data collection, data mining, robots or any
                  other data gathering methods of any kind on the Website and/or
                  Persistence Products.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  3.8 User may, through hyperlinks displayed on the Website,
                  gain access to websites operated by persons other than the
                  Company. Such hyperlinks are displayed only for User’s
                  convenience, and we assume no responsibility for the use of
                  any third-party software or other materials on the Website.
                </Text>
              </Box>
              <Text className={"subHeading"}>
              ...
              <Box>
                ...
                <Text className={"contentClass"} mb={4}>
                  4.2.4 an individual or body corporate included in United
                ...
                <Text className={"contentClass"} mb={4}>
                  ...
                  corporate from accessing and/or using Persistence Products;
                  and/or
                </Text>
                <Text className={"contentClass"} mb={4}>
                  4.2.6 a U.S. person.{" "}
                ...
                <UnorderedList className={"list-disc pl-5"}>
                  ...
                  <ListItem className={"contentClass"} mb={4}>
                    ...
                    United States who is not resident in or outside of the
                    United States,
                  </ListItem>
                  <Text className={"contentClass"} mb={4}>
                  ...
                  <ListItem className={"contentClass"} mb={4}>
                    any discretionary account or similar account (other than an
                    estate or trust) held for the benefit or account of a
              ...
              <Box>
                ...
                <UnorderedList className={"list-disc pl-5"}>
                  ...
                  <ListItem className={"contentClass"} mb={4}>
                    ...
                    document from time-to-time governing User access and/or use
                    of Persistence Products;
                  </ListItem>
                </UnorderedList>
                <Text className={"contentClass"} mb={4}>
                  5.2 permit others to access Persistence Products through
                  User’s wallet or a blockchain address User controls or
                  otherwise engage in transactions using Persistence Products
                  for any person other than the wallet owner;
                </Text>
                <Text className={"contentClass"} mb={4}>
                  5.3 disrupt, interfere with, or otherwise adversely affect the
                  normal flow or function of Persistence Products or otherwise
                  act in a manner that may negatively affect other users’
                  experience when using Persistence Products, and User shall not
                  take advantage of software vulnerabilities and any other act
                  that intentionally abuses or exploits the design and functions
                  of Persistence Products;
                </Text>
                <Text className={"contentClass"} mb={4}>
                ...
                <Text className={"contentClass"} mb={4}>
                  5.7 copy, reproduce, republish, upload, post, transmit,
                  resell, or distribute in any way, any data, content, or any
                  part of Persistence Products except as expressly permitted by
                  applicable laws; and
                </Text>
                <Text className={"contentClass"} mb={4}>
                  5.8 reverse engineer or attempt to reverse engineer
                  Persistence Products except as expressly permitted by
                  applicable law, (collectively, “Prohibited Uses”).
                </Text>
              </Box>
              <Text className={"subHeading"}>
                <b>6. Waivers</b>
              ...
              <Box>
                <Text className={"contentClass"} mb={4}>
                  ...
                  any of our Affiliates (as defined below) shall be liable to
                  User for any direct, indirect, special, incidental,
                  consequential or other losses of any kind, in tort, contract
                  or otherwise (including but not limited to loss of revenue,
                  income or profits, and loss of use or data), arising out of or
                  in connection with User’s access and/or use of Persistence
                  Products.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  6.2 User undertakes not to initiate or participate, and waives
                  the right to participate in, any class action lawsuit or a
                  class-wide arbitration against Company and/or our Affiliates
                  in relation to User’s access and/or use of Persistence
                  Products.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  6.3 By accepting these Terms, User waives all rights, claims
                  and/or causes of action (present or future) under law
                  (including any tortious claims) or contract against the
                  Persistence Associated Entities and its Affiliates in
              ...
              <Box>
                <Text className={"contentClass"} mb={4}>
                  ...
                  legally binding on User for so long as User accesses and/or
                  uses Persistence Products.
                </Text>
                <Text className={"contentClass"} mb={4}>
                ...
                <Text className={"contentClass"} mb={4}>
                  7.3 Neither the Company nor any of our Affiliates will have
                  any liability whatsoever to User for any such restriction,
              ...
              <Box>
                ...
                <UnorderedList className={"list-disc pl-5"}>
                  ...
                  <ListItem className={"contentClass"} mb={4}>
                    THE PERSISTENCE ASSOCIATED ENTITIES HAS NOT MADE AND MAKES
                    NO REPRESENTATION, WARRANTY AND/OR CONDITION OF ANY KIND
                    THAT PERSISTENCE PRODUCTS WILL MEET USER’S REQUIREMENTS,
                  ...
                  <ListItem className={"contentClass"} mb={4}>
                    ...
                    INFORMATION PROVIDED BY PERSISTENCE ASSOCIATED ENTITIES OR
                    ANY OF ITS AFFILIATES IS INTENDED AS OR SHALL BE CONSTRUED
                    AS INVESTMENT, FINANCIAL, TAX, LEGAL OR ANY OTHER KIND OF
                    ADVICE. THE PERSISTENCE ASSOCIATED ENTITIES SHALL NOT BE
                    LIABLE FOR ANY DECISIONS USER MAKES TO ACCESS AND/OR USE
                    PERSISTENCE PRODUCTS.
                  </ListItem>
                  <ListItem className={"contentClass"} mb={4}>
                ...
                <Text className={"contentClass"} mb={4}>
                  ...
                  OF ITS AFFILIATES WILL BE LIABLE TO YOU FOR ANY LOSS OR
                  DAMAGES OF ANY SORT INCURRED AS THE RESULT OF ANY INTERACTIONS
              ...
              <Box>
                ...
                <UnorderedList className={"list-disc pl-5"}>
                  ...
                  <ListItem className={"contentClass"} mb={4}>
                    WHETHER FOR ANY CAUSE WHATSOEVER AND REGARDLESS OF THE FORM
                    OF THE ACTION,
                  </ListItem>
                </UnorderedList>
                <Text className={"contentClass"} mb={4}>
              ...
              <Box>
                <Text className={"contentClass"} mb={4}>
                  10.1 User shall indemnify and hold the Company and/or any of
                  our Affiliates, each of their respective employees, officers,
                  directors and representatives (collectively, “Indemnified
                  Party”), harmless, including costs and attorneys’ fees, from
                  any loss, claim or demand made due to or arising out of:
                </Text>
                <UnorderedList className={"list-disc pl-5"}>
                  <ListItem className={"contentClass"} mb={4}>
                    User’s access and/or use of Persistence Products;
                ...
                <Text className={"contentClass"} mb={4}>
                  ...
                  indemnification, and User agrees to cooperate in the defence
                  of these claims. User shall not settle any matter without the
                  prior written consent of the relevant Indemnified Party. The
                  relevant Indemnified Party will use reasonable efforts to
                  notify User of any such claim, action or proceeding upon
              ...
              <Box>
                <Text className={"contentClass"} mb={4}>
                  User is solely responsible for determining the tax
                  implications and tax reporting requirements associated with
                  transactions User engages in using Persistence Products, and
                  for paying any applicable taxes in each applicable
                  jurisdiction. Neither the Company nor any of our Affiliates
                  shall be responsible for determining whether there are tax
                  implications in connection with transactions involving User’s
                  use of Persistence Products, for reporting any such
                  transactions, or for paying any applicable taxes.
                </Text>
              </Box>
              <Text className={"subHeading"}>
                <b>
                  12. Potential Risks Associated with Use of Persistence
                  Products
                </b>
              </Text>
              <Box>
                ...
                <Text className={"contentClass"} mb={4}>
                  12.1 Persistence Products allows User access to the
                  Persistence Chain to engage in aforementioned activities on
                  User’s own account and at User’s own risk.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  12.2 Using digital assets, staking, running nodes, providing
                  liquidity and/or other forms of interfacing with digital
                  assets entails a high financial risk. User has necessary
                  experience and knowledge to understand the risks involved.
                  User should carefully assess User’s financial circumstances
                  and risk tolerance and where appropriate, seek third party
                  financial advice before engaging in the aforementioned
                  activities.
                </Text>
                <Text className={"contentClass"} mb={4}>
                ...
                <UnorderedList className={"list-disc pl-5"}>
                  <ListItem className={"contentClass"} mb={4}>
                    financial or investment advice. We do not provide any view
                ...
                <Text className={"contentClass"} mb={4}>
                  ...
                  ensure the security of Persistence Products including
                  obtaining or procuring the obtaining of third-party security
                  audits, the technology constituting Persistence Products, and
                  their interaction, is relatively new and it is not possible to
                  guarantee that the code is completely free from bugs or
                  errors.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  12.6 User accepts all risks that arise from User’s access
                  and/or use of Persistence Products, including and not limited
                  to, the risk of any of Tokens being lost due to a failure or
                  exploit of Persistence Products.
                </Text>
                <Text className={"contentClass"} mb={4}>
                ...
                <Text className={"contentClass"} mb={4}>
                  ...
                  containing such private keys, may access User’s Supported
                  Wallet controlled with those private keys with or without
                  User’s authorisation and may transfer any Tokens accessible
                  through User’s Supported Wallet.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  12.9 In choosing to access and/or use Persistence Products,
                  User does so on User’s own initiative and at User’s own risk,
                  and User is responsible for complying with all applicable
                  local laws, rules and regulations relating to User’s access
                  and/or use of Persistence Products.
                </Text>
                <Text className={"contentClass"} mb={4}>
                ...
                <Text className={"contentClass"} mb={4}>
                  ...
                  Products may not support activity related to any Forked
                  Assets. Forked Networks and the available supply of any Forked
                  Assets are wholly outside Persistence Associated Entities’
                  control. In the event of a Fork, Persistence Associated
                  Entities may temporarily suspend certain services on the
                  Website (with or without advance notice to User) while it is
                  determined which Forked Network(s) to support. Persistence
                  Associated Entities shall not be responsible for a lack of
                  support for any Forked Asset.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  ...
                  express or implied representations and warranties, including
                  implied representations or warranties of accuracy,
                  merchantability, fitness for a particular purpose and
                  non-infringement in relation to Persistence Products. Neither
                  the Company nor any of its Affiliates is responsible or liable
                  for any error, delay or interruption in or lack of access to
                  Persistence Products or for any loss of digital assets
                  (including but not limited to Tokens) occasioned by or
                  attributable to Persistence Products.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  ...
                  hold, and/or dispose Tokens if doing so is prohibited or
                  subject of compliance in the relevant jurisdiction applicable
                  including circumstances where your interaction in Tokens
                  results in Tokens and/or your activities associated with
                  ...
                  this Section 12.13 or the Activities.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  12.14 There are inherent risks associated with distributed
                  ledger technologies and blockchain-based networks which are
                  experimental in nature. Transactions based on such
                  technologies are generally immutable, which means that any
                  error may result in transactions being irreversible.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  12.15 Support for the Activities whether provided by the
                  Company or otherwise, may be impacted by regulatory actions
                  which may disrupt, limit or cease the provision of such
                  support.
                </Text>
                <Text className={"contentClass"} mb={4}>
                ...
                <Text className={"contentClass"} mb={4}>
                  ...
                  Products, including the Persistence Documentation may not
                  always be accurate, complete, or up to date. You acknowledge
                  that it is your responsibility to verify all information
                  before relying on it. No representation in respect of such
                  information is made as to the constant accuracy, completeness
                  or appropriateness for any particular purpose.
                </Text>
              </Box>
              <Text className={"subHeading"}>
              ...
              <Box>
                <Text className={"contentClass"} mb={4}>
                  ...
                  Privacy Policy) constitute the entire agreement between User
                  and the Company regarding User’s access and/use of Persistence
                  Products.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  14.2 <b>Relationship of Parties</b>: Nothing contained in
                  these Terms will be deemed to be construed as creating a
                  partnership or an agency relationship or joint venture between
                  User, the Company and/or any of our Affiliates.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  ...
                  null and void. The Company may freely assign these Terms and
                  our respective rights thereunder.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  ...
                  right or remedy under these Terms shall not operate as a
                  waiver of such right or remedy, nor shall it prevent any
                  future exercise or enforcement of such right or remedy, and no
                ...
                <Text className={"contentClass"} mb={4}>
                  ...
                  Affiliates who shall have the rights and benefits to the
                  extent accorded thereto under these Terms, any person who is
                  not a Party shall have no right under the Contracts (Rights of
                  Third Parties) Act 2001 of Singapore to enforce any of these
                  Terms.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  ...
                  disputes or claims) of such agreement, shall be governed by
                  and construed in accordance with the law of Singapore. The
                  Parties agree that any dispute or claim arising out of or in
                  ...
                  the relevant Party or its assets. The arbitration shall be
                  conducted under the rules of the Singapore International
                  Arbitration Centre (“SIAC”). The arbitral tribunal shall
                  consist of a sole arbitrator to be appointed by the President
                  of the SIAC. The seat of the arbitration shall be Singapore.
                ...
                <Text className={"contentClass"} mb={4}>
                  ...
                  law, such unenforceability or invalidity shall not render
