      ...
      <Box className="container">
        <Box className="content">
          ...
          <Box className="data">
            ...
            <br />
            <Text ml={6} className={"contentClass"} fontSize="16px">
              8.1.1 PERSISTENCE DEX IS PROVIDED ON AN "AS-IS" AND "AS AVAILABLE"
              BASIS BY THE COMPANY, AND THE PERSISTENCE DEX GROUP EXPRESSLY
              DISCLAIMS ANY AND ALL REPRESENTATIONS, WARRANTIES AND/OR
            ...
            <br />
            <Text ml={6} className={"contentClass"} fontSize="16px">
              8.1.2 THE PERSISTENCE DEX GROUP HAS NOT MADE AND MAKES NO
              REPRESENTATION, WARRANTY AND/OR CONDITION OF ANY KIND THAT
              PERSISTENCE DEX WILL MEET USER'S REQUIREMENTS, WILL BE AVAILABLE
            ...
            <br />
            <Text ml={6} className={"contentClass"} fontSize="16px">
              8.1.3 NEITHER PERSISTENCE DEX NOR ANY OF ITS AFFILIATES IS USER'S
              BROKER, AGENT, TAX OR LEGAL ADVISOR, AND HAS NO FIDUCIARY
              RELATIONSHIP WITH OR OBLIGATION TO USER. NO COMMUNICATION OR
              INFORMATION PROVIDED BY PERSISTENCE DEX OR ANY OF ITS AFFILIATES
              IS INTENDED AS OR SHALL BE CONSTRUED AS INVESTMENT, FINANCIAL,
              TAX, LEGAL OR ANY OTHER KIND OF ADVICE. THE PERSISTENCE DEX GROUP
              SHALL NOT BE LIABLE FOR ANY DECISIONS USER MAKES TO ACCESS AND/OR
              USE PERSISTENCE DEX.
            </Text>
            <br />
            <Text ml={6} className={"contentClass"} fontSize="16px">
              ...
              ACCESS AND/OR USE OF PERSISTENCE DEX, ALL SUCH REPRESENTATION,
              WARRANTY AND/OR CONDITION ARE LIMITED IN DURATION TO NINETY (90)
              DAYS FROM THE DATE OF FIRST ACCESS AND/USE BY USER OF PERSISTENCE
              DEX.
            </Text>
            <br />
            8.2 THE PERSISTENCE DEX GROUP DOES NOT ENDORSE ANY THIRD PARTY AND
            SHALL NOT BE RESPONSIBLE IN ANY WAY FOR ANY TRANSACTIONS YOU ENTER
            ...
            PERSISTENCE DEX AND/OR ANY OF OUR AFFILIATES BE LIABLE TO USER OR
            ANY THIRD PARTY FOR ANY LOST PROFITS, LOST DATA, OR ANY INDIRECT,
            CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL OR PUNITIVE DAMAGES
            ARISING OUT OF USER'S ACCESS AND/OR USE OF PERSISTENCE DEX, EVEN IF
            THE COMPANY AND/OR ANY OF ITS AFFILIATES HAS BEEN ADVISED OF THE
            POSSIBILITY OF SUCH DAMAGES.
            <br />
            <br />
            9.2 USER'S ACCESS TO AND/OR USE OF PERSISTENCE DEX IS AT USER'S OWN
            ...
            ACCESS AND/OR USE OF PERSISTENCE DEX:
            <br />
            <br />
            <Text ml={6} className={"contentClass"} fontSize="16px">
