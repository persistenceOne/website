      ...
      <Box>
        <Box>
          ...
          <Text fontSize={"18px"} mb={4} fontWeight={500}>
            Last Updated Date: 13 July 2023
          </Text>
          <Box>
            ...
            <Box>
              <Text className={"contentClass"} mb={"4"}>
                ...
                incorporated in the British Virgin Islands) (collectively
                referred to herein as “<b>pSTAKE</b>”, “<b>us</b>”, “<b>we</b>”
                or “<b>our</b>”).
              </Text>
              <Box>
                <Text className={"contentClass"} mb={"4"}>
              ...
              <Text className={"contentClass"} mb={"4"}>
                ...
                : Email : hello@pstake.finance This does not affected your
            ...
            <Text className={"contentClass"} mb={"4"}>
              ...
              supersede earlier versions and will apply to personal data
              provided to us. The updated Privacy Policy will take effect when
              made available on https://pstake.finance/privacy.
            </Text>
            <Text className={"subHeading"}>
            ...
            <Box>
              ...
              <Text className={"contentClass"} mb={"4"}>
                3.3 <b>Providing personal data belonging to others.</b> In
                ...
                individuals relating to our collection, use and disclosure of
            ...
            <Box>
              <Text className={"contentClass"} mb={"4"}>
                ...
                that is relevant to our relationship with you. We may collect
                your personal data directly or indirectly through various
                channels, such as when:
              </Text>
              <UnorderedList className={"list-disc pl-5"}>
                <ListItem className={"contentClass"} mb={"4"}>
            ...
            <Box>
              <Text className={"contentClass"} mb={"4"}>
                5.1 <b> What we do.</b> We collect, use, disclose and process
            ...
            <Box>
              ...
              <UnorderedList className={"list-disc pl-5"}>
                <ListItem className={"contentClass"} mb={"4"}>
                  ...
                  generated by the server) so you dont have to re-enter
              ...
              <Text className={"contentClass"} mb={"4"}>
                ...
                will not prevent the display of advertisements but will mean
                that they will no longer be personalised to your interests.
              </Text>
              <UnorderedList className={"list-disc pl-5"}>
                <ListItem className={"contentClass"} mb={"4"}>
          ...
          <Box>
            ...
            <Text className={"contentClass"} mb={"4"}>
              ...
              in accordance with this policy and applicable laws regardless of
              the jurisdictions they are transferred to, but in any event to a
              level that is no less stringent than the jurisdiction from which
              the personal data is transferred. When we transfer your personal
              data internationally and where required by applicable law we put
              in place appropriate safeguards including EU Model Clauses or rely
              on EU Commission adequacy decisions. You may obtain details of
          ...
          <Box>
            <Text className={"contentClass"} mb={"4"}>
              ...
              under our control, you agree not to hold us liable or responsible
              for any loss or damage resulting from unauthorised or unintended
              access that is beyond our control, such as hacking or cybercrimes.
            </Text>
            <Text className={"contentClass"} mb={"4"}>
            ...
            <Text className={"contentClass"} mb={"4"}>
              ...
              data analytics, audit, accounting or reporting purposes. How long
              we keep your personal data depends on the nature of the data, e.g.
              we keep personal data for at least the duration of the limitation
