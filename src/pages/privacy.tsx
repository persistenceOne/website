            ...
            <Box className="data">
              ...
              <Box>
                ...
                <UnorderedList className={"list-disc pl-5"}>
                  <ListItem className={"contentClass"} mb={4}>
                    access or use our websites and applications (including
                    mobile and web-based applications) (collectively, “
                ...
                <Text className={"contentClass"} mb={4}>
                  1.3 We will only use your personal data where you have given
                  us your consent or where we have other lawful basis for doing
                  so, and in the manner set out in this Privacy Policy.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  1.4 By providing us with personal data, you acknowledge that
                  our collection, use, disclosure and processing of personal
                  data will be in accordance with this Policy, including, for
                  the avoidance of doubt, the cross-jurisdictional transfer of
                ...
                <Text className={"contentClass"} mb={4}>
                  ...
                  agreements or arrangements that you may have with us, in
                ...
                <Text className={"contentClass"} mb={4}>
                  ...
                  complaint to us, you may contact our Data Protection Officer
                  at : Email : hello@persistence.one This does not affected your
                  ...
                  the European Union where you are habitually resident, where
                  you work or where an alleged infringement of Data Protection
                  law has taken place. When you contact us, we may require that
              ...
              <Box>
                <Text className={"contentClass"} mb={4}>
                  ...
                  personal data provided to us. The updated Privacy Policy will
                  take effect when made available on{" "}
                  <a
              ...
              <Box>
                <Text className={"contentClass"} mb={4}>
                  ...
                  data include wallet addresses, and user-specific information
                  for analytical purposes, email addresses and any other
                  information of a personal nature.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  3.2 <b> Voluntary provision of personal data.</b> We may
                  collect personal data (1) that you voluntarily provide to us;
                  or (2) from third parties; or (3) through your use of our (or
                  our services provider’s) digital technologies and services
                  (Please see Section 4 How We Collect Personal Data for further
                  details). What personal data we collect depends on the
                  purposes for which the personal data is collected and what you
                  have chosen to provide. When our collection is based on
                  consent, you can choose not to provide us with personal data.
                  You also have the right to withdraw your consent for us to
                  continue collecting, using, disclosing and processing your
                  personal data, by contacting us in accordance with paragraph
                  1.7. However, if you do so, it may not be possible for us to
                  fulfil the purposes for which we require the personal data,
                  including processing your transactions or providing you with
                ...
                <Text className={"contentClass"} mb={4}>
                  ...
                  data of persons other than yourself (such as your team
                  members, family members and next-of-kin). If you do so, you
                  represent and warrant that you have brought this Privacy
                  Policy to his/her attention, informed him/her of the purposes
                  for which we are collecting his/her personal data and that
                  he/she has consented to your disclosure of his/her personal
                  data to us for those purposes and accepts this Privacy Policy.
                  You agree to indemnify and hold us harmless from and against
                  any and all claims by such inBoxiduals relating to our
                  collection, use and disclosure of such personal data in
                  accordance with the terms of this Privacy Policy.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  3.4<b> Accuracy and completeness of personal data.</b> You are
                  responsible for ensuring that all personal data that you
                  provide to us is true, accurate and complete. You are
                ...
                <Text className={"contentClass"} mb={4}>
                  ...
                  Applications and/or services are also not intended for
                  Excluded Persons, and/or access and/or use in Excluded
                  Jurisdictions. Please refer to the relevant terms (including
                  the Foundation Delegation Program Terms and Conditions) for
                  the specific excluded persons and jurisdictions.
                </Text>
              </Box>
              <Text className={"subHeading"}>
              ...
              <Box>
                <Text className={"contentClass"} mb={4}>
                  4.1 Personal data you provide. We collect personal data that
                ...
                <UnorderedList className={"list-disc pl-5"}>
                  ...
                  <ListItem className={"contentClass"} mb={4}>
                    ...
                    platforms (such as Telegram and Slack), face-to-face
                    meetings, telephone calls, emails, fax and letters;
                  </ListItem>
                  <ListItem className={"contentClass"} mb={4}>
                    your request to be included in an e-mail or our mailing
                    list;
                  </ListItem>
                  <ListItem className={"contentClass"} mb={4}>
              ...
              <Box>
                ...
                <Text className={"contentClass"} mb={4}>
                  ...
                  process your personal data for purposes connected or relevant
                  to our business, to manage your relationship with us. Such
                ...
                <UnorderedList className={"list-disc pl-5"}>
                  ...
                  <ListItem className={"contentClass"} mb={4}>
                    ...
                    verifying and establishing your identity, and
                    authenticating, operating and maintaining user accounts;
                  </ListItem>
                  <ListItem className={"contentClass"} mb={4}>
                  ...
                  <ListItem className={"contentClass"} mb={4}>
                    ...
                    services from unauthorised access or usage and to monitor
                  ...
                  <ListItem className={"contentClass"} mb={4}>
                    ...
                    countering the financing of terrorism laws), or to assist in
                  ...
                  <ListItem className={"contentClass"} mb={4}>
                    ...
                    you, and to improve our Applications and services;
                  </ListItem>
                  <ListItem className={"contentClass"} mb={4}>
                ...
                <Text className={"contentClass"} mb={4}>
                  Where personal data is used for a new purpose and where
                  required under applicable law, we shall obtain your consent.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  5.3 Legitimate business interests. We may also collect, use,
                  disclose and process your personal data for the following
                  purposes to support our legitimate business interests,
                ...
                <Text className={"contentClass"} mb={4}>
                  ...
                  personal data in non-aggregated and/or identifiable form would
                  be carried out unless you have provided us with your consent
                  to use your personal data for such marketing purposes. If you
                  do not want us to use your personal data for the purposes of
                  marketing you can withdraw your consent at any time by
                  contacting us in accordance with paragraph 1.7.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  5.5 <b>Use permitted under applicable laws.</b> We may also
                  collect, use, disclose and process your personal data for
                  other purposes, without your knowledge or consent, where this
                  is required or permitted by law. Your personal data may be
                ...
                <Text className={"contentClass"} mb={4}>
                  ...
                  have consented, we may do so by post, e-mail, SMS, telephone
                  or such other means provided by you. If you do not wish to
                  receive any communication or information from us, or wish to
                  restrict the manner by which we may contact or send you
                  information, you may contact us in accordance with paragraph
                  1.7 above.
                </Text>
              </Box>
              <Text className={"subHeading"}>
              ...
              <Box>
                <Text className={"contentClass"} mb={4}>
                  ...
                  small file of letters and numbers that we store via your
                  browser on the hard drive of your computer or mobile device.
                ...
                <UnorderedList className={"list-disc pl-5"}>
                  <ListItem className={"contentClass"} mb={4}>
                    ...
                    you to browse our Applications and use its features. The
                  ...
                  <ListItem className={"contentClass"} mb={4}>
                    ...
                    sometimes placed by third party providers of web traffic and
                    analysis services. We use Google Analytics. For information
                    on how Google processes and collects your information and
                    how you can opt out, please click here.
                  </ListItem>
                </UnorderedList>
                <Text className={"contentClass"} mb={4}>
                  We may also automatically collect and store certain
                  information about your interaction with our Applications
                  including IP address, browser type, internet service provider,
                ...
                <UnorderedList className={"list-disc pl-5"}>
                  ...
                  <ListItem className={"contentClass"} mb={4}>
                    ...
                    and will be received by the third party and are controlled
                    by the third party.
                  </ListItem>
                  <ListItem className={"contentClass"} mb={4}>
                    <b> SDKs:</b> these are mobile application third party
                    software development kits used in our apps. They enable us
                    to collect information about app activity and the device it
                    runs on.
                  </ListItem>
                  <ListItem className={"contentClass"} mb={4}>
                    <b>Local shared objects:</b> these are sometimes called
                    flash cookies and can be stored on your browser. They are
                    used to maintain preferences and usage records.
                  </ListItem>
                </UnorderedList>
                <Text className={"contentClass"} mb={4}>
                  6.4 <b>Refusing or deleting cookies.</b> Most internet
                  browsers are set up by default to accept cookies. However if
                  you want to refuse or delete them (or similar technologies)
                  please refer to the help and support area on your browser for
                  instructions on how to block or delete cookies (for example:
                  Internet Explorer, Google Chrome, Mozilla Firefox and Safari).
                  Please note you may not be able to take advantage of all the
                  features of our Applications, including certain personalised
                  features, if you delete or refuse cookies.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  6.5 <b> Mobile Opt-out.</b> Where applicable if we do support
                  a mobile version of our product - If you access our
                ...
                <Text className={"contentClass"} mb={4}>
                  6.6 <b>If you are a resident in the EU.</b> For more
                  information on managing cookies, please visit{" "}
                  <a
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#3e73f0]"
                ...
                <Text className={"contentClass"} mb={4}>
                  6.7 <b>Changes to our uses of Cookies.</b> If we change
                  anything important about this Paragraph 6 on cookies, we will
                  notify you through a pop-up on the website for a reasonable
                  length of time prior to and following the change. You may
                  review this Paragraph by visiting the sites and clicking on
              ...
              <Box>
                <Text className={"contentClass"} mb={4}>
                  ...
                  provide our services to you, manage our shareholder and
                  investor returns, for management and compliance purposes, and
                  to utilise shared group IT functions.
                </Text>
                <Text className={"contentClass"} mb={4}>
                  7.2 <b>Disclosure to third parties.</b> We may also disclose
                  your personal data to third parties in connection with
                  purposes described in paragraph 5, including without
                ...
                <UnorderedList className={"list-disc pl-5"}>
                  <ListItem className={"contentClass"} mb={4}>
                    ...
                    other professional services (including accountants, lawyers
                    and auditors));
                  </ListItem>
                  <ListItem className={"contentClass"} mb={4}>
                ...
                <Text className={"contentClass"} mb={4}>
                  ...
                  third parties to protect your personal data in a manner that
                  is consistent with all applicable laws and/or ensure that they
                  only process your personal data in accordance with our
                  instructions.
                </Text>
              </Box>
              <Text className={"subHeading"}>
              ...
              <Box>
                ...
                <UnorderedList className={"list-disc pl-5"}>
                  <ListItem className={"contentClass"} mb={4}>
                    ...
                    are located) to any other jurisdictions that we operate in;
                    and
                  </ListItem>
                  <ListItem className={"contentClass"} mb={4}>
                ...
                <Text className={"contentClass"} mb={4}>
                  ...
                  regardless of the jurisdictions they are transferred to, but
                  in any event to a level that is no less stringent than the
              ...
              <Box>
                <Text className={"contentClass"} mb={4}>
                  ...
                  precautions to safeguard your personal data in our possession
                  or under our control, you agree not to hold us liable or
                  responsible for any loss or damage resulting from unauthorised
                  or unintended access that is beyond our control, such as
                ...
                <Text className={"contentClass"} mb={4}>
                  ...
                  that you choose to send us electronically. Sending such data
                ...
                <Text className={"contentClass"} mb={4}>
                  ...
                  reporting purposes. How long we keep your personal data
                  depends on the nature of the data, e.g. we keep personal data
                  for at least the duration of the limitation period for
                  bringing claims if the personal data may be required to
                  commence or defend legal proceedings. Some information may
                  also be retained for longer, e.g. where we are required to do
                  so by law.
                </Text>
                <Text className={"contentClass"} mb={4}>
              ...
              <Box>
                <Text className={"contentClass"} mb={4}>
                  10.1 <b> Rights you may enjoy.</b> Depending on the
                ...
                <Text className={"contentClass"} mb={4}>
                  ...
                  in accordance with paragraph 1.7. We may require that you
                  submit certain forms or provide certain information to process
                  your request. Where permitted by law, we may also charge you a
                ...
                <Text className={"contentClass"} mb={4}>
                  ...
                  connection with claims; or (b) an objection request and
                  continue processing your personal data based on compelling
