    ...
    <section className="terms-section">
      <div className="container">
        <div className="content">
          ...
          <p className="last-update">Last Updated Date: 3 November 2023</p>
          <div className="data">
            ...
            <div>
              ...
              <p>1.3 For purposes of these Terms:</p>
              ...
              <p className={"content-text"}>a reference to:</p>
              <ul className={"list-disc pl-5"}>
                <li className={"content-text"}>
            ...
            <div>
              <p className={"content-text"}>2.1 Persistence Chain</p>
              <ul className={"list-disc pl-5"}>
                <li className={"content-text"}>
            ...
            <div>
              <p className={"content-text"}>For purposes of these Terms:</p>
              <p className={"content-text"}>
              ...
              <p className={"content-text"}>4.2.1 a person who is:</p>
              <ul className={"list-disc pl-5"}>
                <li className={"content-text"}>
              ...
              <p className={"content-text"}>4.2.2 a body corporate:</p>
              <ul className={"list-disc pl-5"}>
                <li className={"content-text"}>
              ...
              <p className={"content-text"}>4.2.6 a U.S. person.</p>
              <p className={"content-text"}>4.3 “U.S. person” means:</p>
              <ul className={"list-disc pl-5"}>
                <li className={"content-text"}>
