...
class MaticStakedrop extends Component {
    ...
    componentDidMount = () => {
        ...
        /*  window.ethereum.request({ method: "eth_requestAccounts" }).then((addr) => {
           console.log(addr[0], "address");
           this.setState({ account: addr[0] });
         });
    ...
    render() {
        ...
        return (
                ...
                <section className="participate-stakedrop">
                    ...
                    <>
                      {!this.state.msgShowAlert ? (
                        <h6 className="error valid-add">
                          "Network ID mismatch. Select Ethereum Mainnet in your
                          Metamask / Browser Wallet and Refresh Page"
                        </h6>
                      ) : (
                        <h6 className="error valid-add green">
                          "Connected to Browser Wallet"
                        </h6>
                      )}{" "}
                    </>
                  ) : null} */}
                    ...
                    <div className="body-section">
                      <h6 className="note-text mt-4">
                        <span>Note:</span> Submit your Persistence Address
                        (XPRT) and Staking Address (ETH) you used for MATIC
                        Staking, to receive XPRT StakeDrop
                      </h6>
                      ...
                      <form onSubmit={this.rewardStakingAddress}>
                        ...
                        {this.state.errorxprtAddress ? (
                          <h6 className="text-left valid-add">
                            Enter Valid Persistence Address
                          </h6>
                        ) : (
                          ""
                        )}
                        ...
                        <div className="inputstaking left-align-calculate">
                          ...
                          <div className="btn-calculate mr-2">
                            <button
                              type="submit"
                              disabled={
                                !this.state.account || !this.state.msgShowAlert
                              }
                              className="btn"
                            >
                              Submit
          ...
          >
            <Modal.Body>
              <p className="tc">
                Persistence Address recorded. You will receive the XPRT Rewards
                if you had participated in the StakeDrop Campaign
              </p>
