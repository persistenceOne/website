export const ecosystemList = [
  ...
  },
  {
    ...
    description: "Ethereum <> Persistence Bridge Interface",
    icon: "xprt",
    name: "Tools",
    status: "Live",
  ...
  {
    network: "Coin98",
    description: "All-in-One DeFi platform",
    icon: "coin98",
    name: "Wallet",
    status: "Live",
  ...
  {
    network: "SmartStake",
    description: "Performance assessment & analytics dashboard",
    icon: "smartstake",
    name: "Tools",
    status: "Live",
  ...
  {
    network: "Cosmosdash",
    description: "XPRT and Osmosis Pools Analytics",
    icon: "cosmosdash",
    name: "Tools",
    status: "Live",
